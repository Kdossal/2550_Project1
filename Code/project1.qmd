...
# cor_df <- cor_df[abs(cor_df$value) > 0.5, ]
...
```{r}
# Identify the continuous and binary variables
...
# Dropped page + psex + plang + language bcuz they did not have a strong effect or improve the model very much
```
...
# Dropped page, psex, plang, p_race, t_race, bcuz they did not have a strong effect or improve the model very much
```
